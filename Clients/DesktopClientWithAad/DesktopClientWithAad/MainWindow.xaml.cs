...
namespace DesktopClient
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private async void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                AuthTenant = AppSettings.AuthTenant,
                AuthClientId = AppSettings.AuthClientId,
                AuthClientScope = AppSettings.AuthClientScope,
                AuthB2CHost = AppSettings.AuthB2CHost,
                AuthSignInPolicy = AppSettings.AuthSignInPolicy,
                AuthRedirectUri = AppSettings.AuthRedirectUri
            }, email, apiKey);
            if (token == null)
            {
