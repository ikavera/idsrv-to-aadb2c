...
namespace Auth.Mappers.Common
{
    public abstract class AbstractMapper
    {
        ...
        /// <summary>
        /// DON'T USE THIS METHON UNLESS ABSOLUTELY NECESSARY.
        /// IF YOU DO, PLEASE SURROUND CONNECTIN IN "USING" CLAUSE
        /// </summary>
        /// <returns></returns>
        ...
        protected IList<T> FindMany<T>(string sql)
        {
        ...
        protected IList<T> FindMany<T>(string sql, DynamicParameters parameters)
        {
            var result = new List<T>();
        ...
        protected IList<T> FindMany<T>(string sql, DynamicParameters parameters, Func<dynamic, T> loadFunc)
        {
        ...
        protected IList<T> FindMany<T>(string sql, DynamicParameters parameters, CommandType commandType)
        {
            var result = new List<T>();
        ...
        protected IList<int> FindMany(string sql, DynamicParameters parameters, CommandType commandType)
        {
        ...
        {
            Logger.Error("SQL Exception: " + message);
            Logger.Error(sql);
            if (parameters != null)
            {
                foreach (var name in parameters.ParameterNames)
                {
                    Logger.Error("Parameter: " + name + ", Value: " + parameters.Get<object>(name)?.ToString());
                }
            }
        }
    }
